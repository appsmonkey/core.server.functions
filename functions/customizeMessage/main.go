...
func Handler(event events.CognitoEventUserPoolsCustomMessageRequest) (events.CognitoEventUserPoolsCustomMessageResponse, error) {
	...
	return events.CognitoEventUserPoolsCustomMessageResponse{}, nil
}
